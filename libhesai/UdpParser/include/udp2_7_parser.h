...
#ifndef UDP2_7_PARSER_H
#define UDP2_7_PARSER_H
...
namespace lidar
{
  ...
  // class Udp2_7Parser
  // parsers packets and computes points for ET30
  ...
  class Udp2_7Parser : public GeneralParser<T_Point> {
    public:
      Udp2_7Parser();
      virtual ~Udp2_7Parser();
...
#include "udp2_7_parser.cc"


#endif // UDP2_7_PARSER_H
