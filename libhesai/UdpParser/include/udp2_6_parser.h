...
namespace lidar
{
  ...
  static constexpr int ET_MAX_CHANNEL_NUM_26 = 512;

  struct ETCorrectionsHeader_V6 {
    uint8_t delimiter[2];
    ...
    int16_t beta;
    int16_t gamma;
    ETCorrectionsHeader_V6():angle_division(1)
    {
      major_version = 0;
      min_version = 0;
    }
  };
  struct ETCorrections_V6 {
    struct ETCorrectionsHeader_V6 header;
    float azimuths[ET_MAX_CHANNEL_NUM_26];
    float elevations[ET_MAX_CHANNEL_NUM_26];
    int16_t raw_azimuths[ET_MAX_CHANNEL_NUM_26];
    int16_t raw_elevations[ET_MAX_CHANNEL_NUM_26];
